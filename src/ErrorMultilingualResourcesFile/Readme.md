...
```
    cd "ErrorMultilingualResourcesFile"
    dotnet restore
```

Execute unit tests
```
    cd "ErrorMultilingualResourcesFile/test/ErrorMultilingualResourcesFile.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "ErrorMultilingualResourcesFile/src/ErrorMultilingualResourcesFile"
